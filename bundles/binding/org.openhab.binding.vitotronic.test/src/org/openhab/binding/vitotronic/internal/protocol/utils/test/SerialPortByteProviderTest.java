...
import org.openhab.binding.vitotronic.internal.protocol.utils.SerialPortException;
...
public class SerialPortByteProviderTest {
	 ...
	 */
	@Test
	public void testGetByte() throws SerialPortException {
	...
	@Test
	public void testGetByte_NoAvailableBytes() throws SerialPortException {
	...
	@Test
	public void testGetByte_SerialPortNotOpen() throws SerialPortException {
		byte expectedBytes = 0x00;
		ISerialPort serialPort = mock(ISerialPort.class);
