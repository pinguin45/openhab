 ...
 * @since 1.0.0
 */
public class KesseltemperaturSoll extends Parameter implements IDecimalParameter {
	...
	public String getValueString() {
		return String.format("%.2f", getTemperatur());
	}

	/**
	 * @return KesseltemperaturSoll
	 */
	public double getTemperatur() {
		return getShortInteger() / 10;
	}
