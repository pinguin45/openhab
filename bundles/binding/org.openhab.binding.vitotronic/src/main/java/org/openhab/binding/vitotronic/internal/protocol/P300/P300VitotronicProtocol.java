 ...
 */
package org.openhab.binding.vitotronic.internal.protocol.P300;
 ...
 * @since 1.0.0
 */
public class P300VitotronicProtocol implements IVitotronicProtocol {
	...
	public P300VitotronicProtocol(IParameterFactory parameterFactory) {
	...
	@Override
	public <TParameterValue> IParameterWithValue<TParameterValue> parseReadParameterResponse(IByteQueue bytesToParse) {
		byteQueueToParse = bytesToParse;
				
		return parseCommandResponse(READ_COMMAND);
	}
	
	@Override
	public <TParameterValue> IParameterWithValue<TParameterValue> parseWriteParameterResponse(IByteQueue bytesToParse) {
		byteQueueToParse = bytesToParse;
		
		return parseCommandResponse(WRITE_COMMAND);
	}

	private <TParameterValue> IParameterWithValue<TParameterValue> parseCommandResponse(byte commandByte) {
		...
		ensureNextByteIs(commandByte);
		
		IParameterWithValue<TParameterValue> parameter = parseParameter();
