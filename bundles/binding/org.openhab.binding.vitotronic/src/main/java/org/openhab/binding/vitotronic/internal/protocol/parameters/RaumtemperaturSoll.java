...
import org.openhab.binding.vitotronic.internal.protocol.WriteableParameter;

/**
 * @author Robin Lenz
 *
 */
public class RaumtemperaturSoll extends WriteableParameter implements IDecimalParameter {
	...
	public String getValueString() {
		return String.format("%d", getTemperatur());
	}

	/**
	 * @return die soll Raumtemperatur
	 */
