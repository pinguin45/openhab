 ...
 * @since 1.0.0
 */
public class AktuelleBetriebsartA1M1 extends Parameter implements
		IStringParameter {

	/* (non-Javadoc)
	 * @see org.openhab.binding.vitotronic.internal.protocol.IStringParameter#getValue()
	 */
	@Override
	public String getValue() {
		// TODO Auto-generated method stub
		int mode = getIntegerValueFrom(1);
		
		switch (mode)
		{
			case 0 : return "off";
			case 1 : return "reduced";
			case 2 : return "normal (2)";
	...
	/* (non-Javadoc)
	 * @see org.openhab.binding.vitotronic.internal.protocol.Parameter#getExpectedValueSize()
	 */
	@Override
